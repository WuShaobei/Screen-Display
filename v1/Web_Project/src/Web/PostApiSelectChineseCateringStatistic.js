...
function postApiSelectChineseCateringStatistic(callback){    
    axios.post(
        "http://127.0.0.1:1432/api/v1/select/ChineseCateringStatistic?BeginYear=2014&EndYear=2021"
    ).then(function(res){
        if (res.data.Code == 0){
...
export{
    postApiSelectChineseCateringStatistic
}